...
print(f"The average fare of those who survived is ${round(np.mean(fare_survived))} dollars.")
print(f"The average fare of those who did not survive is ${round(np.mean(fare_not_survived))} dollars.")
